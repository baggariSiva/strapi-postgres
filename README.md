# Strapi-postgres example demo CI/CD pipeline
...
A starter Template for Strapi with postgres database.
...
```
git clone https://github.com/elestio-examples/strapi-postgres.git
```
...
But for this Strapi-postgres Template, you can choose GitHub as your deployment method.

### Step 3: Authentication

Select Clone in step at step Git Repository and select Strapi-postgres template for creating a repository in your git account after that authenticate with Git by clicking on
Continue with Github button and authorize elestio to access git then you can rename you repository name if you want.

Else If you forked the repo then you can click on the Continue with GitHub button and authorize elestio to access the git repo then you can select the Strapi-postgres repo otherwise you can directly insert a git repo URL to deploy the Strapi-postgres application.
